...
export function ThreadIdTooltip({ threadId }: { threadId: string }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <p className="bg-muted text-muted-foreground rounded-md px-1 py-[2px] font-mono text-[10px] leading-[12px] tracking-tighter">
...
export function ThreadIdCopyable({
  ...
  return (
    <TooltipIconButton
      ...
      className="border-border hover:bg-accent flex w-fit flex-grow-0 cursor-pointer items-center gap-1 rounded-md border p-1"
    >
