...
|---|---|---|---|---|
| Plane API | `makeplane/plane-backend:v1.26.0` | Host receipt | https://github.com/makeplane/plane | Re-pin after release compatibility review; stop and preserve volumes to roll back |
| Plane web | `makeplane/plane-frontend:v1.26.0` | Host receipt | https://github.com/makeplane/plane | Re-pin with API; do not mix release lines |
